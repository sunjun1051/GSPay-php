...
// define('GS_PUBKEY', dirname(__FILE__) . '/key/gs/publicKey.keystore');
define('SIGN_PUBKEY', dirname(__FILE__) . '/key/sign/publicKey.keystore');

// GS分配的私钥配置
//private key configuration
// define('GS_PRIVKEY', dirname(__FILE__) . '/key/gs/privateKey_5020001.keystore');
define('SIGN_PRIVKEY', dirname(__FILE__) . '/key/sign/privateKey_5020001.keystore');
