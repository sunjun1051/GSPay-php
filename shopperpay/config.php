...
define('SELLER_API', dir($self_url).'/demo/seller_api.php');
...
// GS订单查询状态回传API
// Merchant order query result call back address.
define('SELLER_GS_QUERY_API', 'http://localhost/shopperpay-sun/demo/gs_order_info.php');
