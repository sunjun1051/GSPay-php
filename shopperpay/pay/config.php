...
define('CHINAPAY_PUBKEY', dirname(dirname(__FILE__)) . '/key/thenatural/PgPubk.key');

// CHINAPAY私钥配置
//private key configuration
define('CHINAPAY_PRIVKEY', dirname(dirname(__FILE__)) . '/key/thenatural/MerPrK_808080071198021_20160711103730.key');
...
$base_url = 'http://'.$_SERVER["SERVER_NAME"].'/shopperpay-2.1.0';
